...
| 4 | Split the largest standalone tools: `web_fetch.go`, `lsp.go`, and `background_commands.go`. | In progress | Starting with `background_commands.go` as the smallest high-leverage split target in this group. |
